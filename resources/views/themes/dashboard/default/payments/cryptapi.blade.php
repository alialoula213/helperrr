<div class="row">
    ...
    <div class="col-lg-6 col-sm-12 text-center">
        ...
        <p class="text-sm">{{ $invoice_params->confirmations }} confirmations required</p>
        <div class="input-group mb-2">
            <input class="form-control text-center" id="paymentWallet" value="{{ $invoice_params->address }}" readonly onclick="this.select();">
